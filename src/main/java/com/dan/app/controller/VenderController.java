...
import com.dan.app.model.ProductoParaVender;
import com.dan.app.model.ProductoVendido;
import com.dan.app.model.Venta;
import com.dan.app.repository.ProductosRepository;
import com.dan.app.repository.ProductosVendidosRepository;
	...
	public String agregarAlCarrito(@ModelAttribute Producto producto, HttpServletRequest request,
		...
		if (!encontrado) {
			carrito.add(new ProductoParaVender(productoBuscadoPorCodigo.getNombre(),
					...
					productoBuscadoPorCodigo.getCantidad(), productoBuscadoPorCodigo.getId(), 1f));
		}
		this.guardarCarrito(carrito, request);
		return "redirect:/vender/";
	}
